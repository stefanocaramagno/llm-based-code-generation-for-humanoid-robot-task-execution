...
def basketball():
    ...
    # Position Basket Ball (2)
    # ball_position = np.array([-0.471,0.831,-0.183]) # In riferimento al centro della scena (0,0,0)
    # ball_position = np.array([0.4628,-0.2318,-0.373]) # In riferimento a Reachy
