...
def basketball():
    ...
    # Position Basket Ball 
    # ball_position = np.array([-0.4513,0.831,-0.0432]) # In riferimento al centro della scena (0,0,0)
    ball_position = np.array([0.4430999,-0.3716,-0.373]) # In riferimento a Reachy
